...
class DefaultShareProvider implements IShareProvider {
	...
	public function getSharesInFolder($userId, Folder $node, $reshares) {
		...
		// make sure we execute the query even if there is no $childMountRootIds
		if (count($childMountRootIds) === 0) {
			$qb->setParameter('chunk', [], IQueryBuilder::PARAM_INT_ARRAY);
		...
		foreach (array_chunk($childMountRootIds, 1000) as $chunk) {
